...
from HW11_koral_kalathia import Repository
...
class Test(unittest.TestCase):
    ...
    def test_data_for_Student(self):
        ...
        self.stevens: Repository = Repository("path")
    ...
    def test_data_for_Instructor(self):
        ...
        stevens: Repository = Repository("path")
    ...
    def test_data_for_student_grades_summary(self):
        ...
        self.assertEqual(
            stevens.student_grades_table_db("path"),
            calculated)
